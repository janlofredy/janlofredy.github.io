...
export const portfolioData = {
    personal: {
        ...
        stats: [
            ...
            { value: "1st", label: "2018 Regional Inter-College ICT Champion" },
    ...
    skillCategories: [
        ...
        {
            category: "Graphics, AI & Personal Hobbies",
            description: "Interactive 3D WebGL, computer vision, plus personal hobbies in simple 3D modeling & 3D printing",
            skills: [
                "Three.js (WebGL)",
                "Autodesk Fusion (Simple 3D Models)",
                "3D Printing (FDM Hobby)",
    ...
    projects: [
        ...
        {
            id: "homelab-devops",
            title: "Self-Hosted Homelab & Container Server",
            subtitle: "Bare-Metal Linux Server & Personal Docker Deployments",
            domain: "Personal Hobby & Self-Hosted Lab",
            role: "Personal Hobby / Self-Use",
            description:
                "Personal self-hosted home server infrastructure built strictly for hobbyist exploration and everyday personal self-consumption. Operates on bare-metal Linux to run containerized home utilities, local staging, internal DNS, and persistent data storage.",
            architectureHighlights: [
                "Built and managed multi-container services for personal self-consumption using Docker and Docker Compose.",
                "Administered personal bare-metal Linux server hardware with isolated bridge networks and persistent host volumes.",
                "Configured local reverse proxying and internal DNS to route personal self-hosted apps across home devices.",
            ],
        ...
        {
            id: "cad-3d-printing",
            title: "Simple 3D Modeling & 3D Printing",
            subtitle: "Autodesk Fusion (Free Personal License) & FDM Printing",
            domain: "Personal Hobby & 3D Printing",
            role: "Personal Hobby / Self-Use",
            description:
                "Hands-on maker hobby creating simple functional 3D models for personal self-consumption. Using the free personal license of Autodesk Fusion to model utility parts, mounts, and brackets, then manufacturing them on a home FDM 3D printer.",
            architectureHighlights: [
                "Designed simple dimensional utility models, desk mounts, and cable brackets in Autodesk Fusion (free personal license).",
                "Configured personal slicing profiles (infill, wall thickness, print speeds) for durable, practical home use.",
                "3D-printed on-demand custom parts to solve everyday home and workspace physical utility needs.",
            ],
    ...
    education: {
        ...
        achievements: [
            "Regional Programming Champion — 1st Place, 2018 Caraga Regional ICT Congress (Inter-College Event)",
